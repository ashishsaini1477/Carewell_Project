...
const route:Routes =[
  {path: '' , component:PagesComponent,
    children : [
      ...
      {path: 'add-jobcard', component:JobcardAddComponent, canActivate:[AuthGuardService]},
      {path: 'jobcard-list', component:JobcardListComponent, canActivate:[AuthGuardService]},
      ...
      {path: 'add-invoice', component:InvoiceComponent, canActivate:[AuthGuardService]},
